...
public interface ProductRepository extends PagingAndSortingRepository<Product, Integer> {
	...
	public Page<Product> findAll(String keyword, Pageable peagable);
	
	@Query("SELECT p FROM Product p WHERE p.category.id = ?1 OR p.category.allParentIDs LIKE %?2%")
	public Page<Product> findAllInCategory(Integer categoryId, String categoryIdMatch, Pageable peagable);
	...
	public Page<Product> searchInCategory(Integer categoryId, String categoryIdMatch, String keyword, Pageable peagable);
